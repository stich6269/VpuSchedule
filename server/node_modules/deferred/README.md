...
$ npm install
$ cd ..
$ webmake --name=deferred deferred/html_parser.js deferred.js
```
...
```
$ webmake --amd deferred/html_parser.js deferred.js
```
...
When preparing client-side file (with help of e.g. [modules-webmake](https://github.com/medikoo/modules-webmake)) you are free to decide, which extensions you want to take (see source of `lib/html_parser.js` on how to do that)
